...
const PAGES: { name: string; href: string; keywords: string }[] = [
  ...
  { name: "Conflicts & Impact", href: "/conflict-resolution", keywords: "conflict resolution disputes impact map dependencies graph" },
  { name: "Compliance", href: "/compliance", keywords: "compliance acknowledgment tracking expiry review due dates" },
  ...
  { name: "Regulatory & Accreditation", href: "/regulatory", keywords: "regulatory joint commission cms survey prep readiness inspection" },
  ...
  { name: "Deviations & Incidents", href: "/incidents", keywords: "incident safety event report exception deviation" },
