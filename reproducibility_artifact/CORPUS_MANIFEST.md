...
| `oh_2021_amerimed.pdf` | Ohio EMS Guidelines and Procedures Manual, ~2021 (third-party mirror, used as the older half of the alignment test in §85) | ⚠️ third-party mirror (amerimed.net), retrieved in an earlier session phase | `b8388c6b9459cb9ed167a110e3e7035fb9f5a50eaf6f2e386eb429ceee8fa906` | 2,212,943 B |
| `oh_2026.pdf` | Ohio EMS Guidelines and Procedures Manual, direct-from-state 2026 — byte-identical to `oh_current.pdf` (a document already in the corpus), not a genuinely new edition, §85 | ✅ `https://dam.assets.ohio.gov/image/upload/ems.ohio.gov/links/ems_Guidelines-Procedures-Manual.pdf` | `4e04a1884d5a46b5...` (see §85 — identical to `oh_current.pdf`) | 3,380,461 B |
| `wv_2026.pdf` | West Virginia 2026 Protocol Booklet — too thin to test alignment (322 items), §85 | ✅ `https://dhhr.wv.gov/oems/medicaldirection/Documents/Protocols/2026/2026%20Protocol%20Booklet%20Final%20April%202026%20-%20INTERACTIVE.pdf` | `6c6a3db5051f8593d3c909bc1e66093fca0b2c36b44b20791f501d436f0b0dac` | 6,645,134 B |
| `sc_202511.pdf` | South Carolina EMS Clinical Operating Guidelines, Nov 2025 — too thin to test alignment (318 items), §85 | ✅ `https://dph.sc.gov/sites/scdph/files/2025-11/EMS_Clinical_Operating_Guidelines_202511.pdf` | `6aa5542c5f4aee3bc2f42a928af7849728117dba643fc4bbf14a5aeabcd2abd6` | 23,867,774 B |
| `nh_v93_20251107.pdf` | New Hampshire Patient Care Protocols, Version 9.3, effective 2025-11-07 — real edition, item-level extraction fails title inspection (garbage anchors), §93 | ✅ user-downloaded directly (`mm.nh.gov`, retrieval blocked for programmatic fetch, §41) | `f291bcdeabd639a0ef4af006e3824d9df8da045dd7a258cc2325701d82041257` | 35,598,367 B |
| `ma_v20261.pdf` | Massachusetts Statewide Treatment Protocols, Official Version 2026.1, June 1 2026 — real edition, item-level extraction fails title inspection, §93 | ✅ user-downloaded directly (`mass.gov`, retrieval blocked by session sandbox, §82) | `e909c0458c49ed22e4aa1f047c1348fad25c1a117bbc4cc5c73ac60177d707d0` | 9,578,982 B |
| `ma_v20262.pdf` | Massachusetts Statewide Treatment Protocols, Official Version 2026.2, September 1 2026 — real edition, item-level extraction fails title inspection, §93 | ✅ user-downloaded directly (`mass.gov`) | `184b9ae16070cc00777db42f9f6e236d330f0dea982f9440bad3a8b75d3e7e48` | 10,097,457 B |
| `ma_2025_fresh.pdf` | Massachusetts Statewide Treatment Protocols, Official Version 2025.1, June 16 2025 — real edition (relabeled here from a prior session's unlabeled filename), item-level extraction fails title inspection, §93 | ✅ retrieved earlier session phase, label confirmed §93.1 | `47e1e384878d2ae020618bc6efe5692f44c86caf5440ba2bd91f641eac66d3eb` | 8,478,924 B |
| `corpus/supporting_docs/ma_v20261_change_memo.pdf` | Massachusetts OEMS official change memo for v2026.1, dated 2026-01-21 — supporting documentation only, not fed to the parser | ✅ user-downloaded directly | `914ff04b250b9a0e07d63134479a78d6d6f57a4967dccb096569c1c2cda511b2` | 260,818 B |
